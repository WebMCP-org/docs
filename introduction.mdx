...
- **WebMCP**: The W3C Web Model Context API standard - defines how websites expose tools to AI agents in browsers. While related to MCP, WebMCP will diverge as a web-native standard with its own evolution path. [View the W3C specification](https://github.com/webmachinelearning/webmcp).
