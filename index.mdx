    ...
    <div className="docs-landing-inner">
      <div className="docs-landing-section-head">
        ...
        <p className="docs-landing-section-copy">
          The tool below is registered right now using <code>navigator.modelContext.registerTool()</code>. Use the <a href="https://chromewebstore.google.com/detail/mcp-b-extension/daohopfhkdelnpemnhlekblhnikhdhfa">MCP-B extension</a> or Chrome's native WebMCP support to call it from an AI agent.
        </p>
      </div>
      ...
      <p className="docs-landing-note docs-landing-note-tight">
        Continue with the [first tool tutorial](/tutorials/first-tool), the [`@mcp-b/webmcp-polyfill` reference](/packages/webmcp-polyfill/overview), or the [`@mcp-b/webmcp-ts-sdk` reference](/packages/webmcp-ts-sdk/overview).
      </p>
    </div>
  </section>
          ...
          <table>
            ...
            <tbody>
              <tr>
                <td>
                  <div className="docs-landing-package-name">
                    <a href="/packages/webmcp-polyfill/overview"><code>@mcp-b/webmcp-polyfill</code></a>
              ...
              <tr>
                <td>
                  <div className="docs-landing-package-name">
                    <a href="/packages/webmcp-types/overview"><code>@mcp-b/webmcp-types</code></a>
                    <div className="docs-landing-links-cell">
              ...
              <tr>
                <td>
                  <div className="docs-landing-package-name">
                    <a href="/packages/usewebmcp/overview"><code>usewebmcp</code></a>
                    <div className="docs-landing-links-cell">
          ...
          <table>
            ...
            <tbody>
              <tr>
                <td>
                  <div className="docs-landing-package-name">
                    <a href="/packages/global/overview"><code>@mcp-b/global</code></a>
                    <div className="docs-landing-links-cell">
              ...
              <tr>
                <td>
                  <div className="docs-landing-package-name">
                    <a href="/packages/webmcp-ts-sdk/overview"><code>@mcp-b/webmcp-ts-sdk</code></a>
                    <div className="docs-landing-links-cell">
              ...
              <tr>
                <td>
                  <div className="docs-landing-package-name">
                    <a href="/packages/transports/overview"><code>@mcp-b/transports</code></a>
                    <div className="docs-landing-links-cell">
              ...
              <tr>
                <td>
                  <div className="docs-landing-package-name">
                    <a href="/packages/mcp-iframe/overview"><code>@mcp-b/mcp-iframe</code></a>
                    <div className="docs-landing-links-cell">
              ...
              <tr>
                <td>
                  <div className="docs-landing-package-name">
                    <a href="/packages/react-webmcp/overview"><code>@mcp-b/react-webmcp</code></a>
                    <div className="docs-landing-links-cell">
          ...
          <table>
            ...
            <tbody>
              <tr>
                <td>
                  <div className="docs-landing-package-name">
                    <a href="/packages/webmcp-local-relay/overview"><code>@mcp-b/webmcp-local-relay</code></a>
                    <div className="docs-landing-links-cell">
              ...
              <tr>
                <td>
                  <div className="docs-landing-package-name">
                    <a href="/packages/extension-tools/overview"><code>@mcp-b/extension-tools</code></a>
                    <div className="docs-landing-links-cell">
              ...
              <tr>
                <td>
                  <div className="docs-landing-package-name">
                    <a href="/packages/chrome-devtools-mcp/overview"><code>@mcp-b/chrome-devtools-mcp</code></a>
                    <div className="docs-landing-links-cell">
