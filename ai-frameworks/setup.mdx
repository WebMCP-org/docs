...
description: 'Install packages and configure MCP client for frontend AI integration. Complete setup guide for TabClientTransport and tool consumption in React applications.'
icon: 'gear'
---
