...
description: 'Build your own AI integration with WebMCP tools using direct MCP client integration. Complete control over tool execution for any AI framework or custom runtime.'
icon: 'code'
---
