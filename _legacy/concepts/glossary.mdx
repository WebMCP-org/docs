---
title: 'Glossary'
description: 'Key terminology and concepts used in WebMCP documentation. Complete reference for WebMCP, MCP, W3C Web Model Context API, tools, transports, and protocol terms.'
icon: 'book'
---
...
**Technical Proposal**: https://github.com/webmachinelearning/webmcp/blob/main/docs/proposal.md
