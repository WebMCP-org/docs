...
<Columns cols={3}>
  ...
  <Card title="React developer" icon="react">
    ...
    **Start here:**
    ...
    - [@mcp-b/react-webmcp reference](/packages/react-webmcp/overview) (reference)
  </Card>
  <Card title="AI agent builder" icon="robot">
    ...
    **Start here:**
    ...
    - [Transports reference](/packages/transports/overview) (reference)
  </Card>
</Columns>
...
<Steps>
  <Step title="Types only: @mcp-b/webmcp-types">
    ...
    [Reference](/packages/webmcp-types/overview)
  </Step>
  <Step title="Strict core polyfill: @mcp-b/webmcp-polyfill">
    ...
    [Reference](/packages/webmcp-polyfill/overview)
  </Step>
  <Step title="Full runtime: @mcp-b/global">
    ...
    [Reference](/packages/global/overview) | [Choose a runtime](/how-to/choose-runtime)
  </Step>
  <Step title="React hooks: @mcp-b/react-webmcp or usewebmcp">
    ...
    **`usewebmcp`** provides a single hook for strict core `navigator.modelContext` tool registration.
    ...
    [react-webmcp reference](/packages/react-webmcp/overview) | [usewebmcp reference](/packages/usewebmcp/overview) | [Framework guide](/how-to/frameworks)
  </Step>
</Steps>
