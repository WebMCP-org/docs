...
<Info>
  For general SSR patterns and common issues, see [Framework Gotchas](/ai-frameworks/framework-gotchas). For the base Vue composable pattern, see [Vue Integration](/frameworks/vue).
</Info>
