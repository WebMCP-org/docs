...
<Info>
  For schema validation with Zod, see the [Schemas Guide](/concepts/schemas). For response formatting, see [Tool Registration](/concepts/tool-registration#response-format).
</Info>
...
<AccordionGroup>
  ...
  <Accordion title="Memory leaks from missing cleanup">
    The composable handles cleanup automatically. For manual registration, see [Lifecycle Management](/concepts/tool-registration#cleanup-and-lifecycle).
  </Accordion>
</AccordionGroup>
