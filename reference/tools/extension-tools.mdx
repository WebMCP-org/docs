...
keywords: ["@mcp-b/extension-tools", "chrome extension", "MCP tools", "TabsApiTools", "BookmarksApiTools", "StorageApiTools", "BaseApiTools", "chrome api"]
icon: "puzzle-piece"
---
...
- [@mcp-b/smart-dom-reader](/reference/tools/smart-dom-reader) (DOM extraction used by `DomExtractionTools`)
- [@mcp-b/transports](/reference/runtime/transports) (browser MCP transports)
- [@mcp-b/chrome-devtools-mcp](/reference/tools/chrome-devtools-mcp) (DevTools Protocol bridge)
