...
- [@mcp-b/extension-tools](/reference/tools/extension-tools) (uses `smart-dom-reader` for DOM extraction tools)
- [@mcp-b/chrome-devtools-mcp](/reference/tools/chrome-devtools-mcp) (DevTools-based browser automation)
