...
WebMCP is a proposed web standard. Native support is currently a Chromium preview behind a flag. For all other browsers, use [`@mcp-b/webmcp-polyfill`](/reference/runtime/webmcp-polyfill) or [`@mcp-b/global`](/reference/runtime/global).
