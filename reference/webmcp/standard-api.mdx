...
For shim configuration, see [@mcp-b/webmcp-polyfill](/reference/runtime/webmcp-polyfill). For end-to-end testing patterns, see [Test native and polyfill](/how-to/test-native-and-polyfill).
...
For native preview availability, flags, and current browser support, see [Browser support and flags](/reference/webmcp/browser-support-and-flags).
...
| If you need... | Page |
| --- | --- |
| Strict core runtime behavior in all browsers | [@mcp-b/webmcp-polyfill](/reference/runtime/webmcp-polyfill) |
| Full runtime with prompts, resources, and transport | [@mcp-b/global](/reference/runtime/global) |
| MCP-B extension methods (`callTool`, `registerPrompt`, `registerResource`, `createMessage`, `elicitInput`) | [MCP-B extension API](/reference/runtime/mcp-b-extension-api) |
| TypeScript contracts for the standard surface | [@mcp-b/webmcp-types](/reference/runtime/webmcp-types) |
