...
keywords: ["@mcp-b/webmcp-ts-sdk", "BrowserMcpServer", "McpServer", "dynamic tool registration", "mcp sdk", "registerTool", "transport connection"]
icon: "layer-group"
---
...
These methods implement the [navigator.modelContext API](/reference/webmcp/standard-api). When a `native` context is provided, operations mirror to it.
...
- [`@mcp-b/global`](/reference/runtime/global) -- Uses `BrowserMcpServer` internally
- [`@mcp-b/transports`](/reference/runtime/transports) -- Tab and iframe transports
