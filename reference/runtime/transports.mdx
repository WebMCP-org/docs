...
keywords: ["@mcp-b/transports", "TabServerTransport", "TabClientTransport", "IframeParentTransport", "IframeChildTransport", "ExtensionServerTransport", "postMessage"]
icon: "network-wired"
---
...
- [@mcp-b/mcp-iframe](/reference/runtime/mcp-iframe) for the high-level `<mcp-iframe>` custom element that wraps iframe transports
