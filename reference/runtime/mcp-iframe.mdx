...
keywords: ["@mcp-b/mcp-iframe", "mcp-iframe", "iframe bridge", "web component", "custom element", "cross-origin", "tool bridging"]
icon: "frame"
---
...
- [@mcp-b/transports](/reference/runtime/transports) for the underlying `IframeParentTransport` and `IframeChildTransport`
