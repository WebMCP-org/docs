...
keywords: ["@mcp-b/global", "initializeWebModelContext", "cleanupWebModelContext", "BrowserMcpServer", "transport", "auto-initialization", "mcp-b runtime"]
icon: "globe"
---
...
After initialization, `navigator.modelContext` still supports the [strict WebMCP surface](/reference/webmcp/standard-api), but it also exposes [MCP-B extension methods](/reference/runtime/mcp-b-extension-api) such as prompts, resources, sampling, elicitation, and transport-facing helpers.
...
For the MCP-B-only methods on `navigator.modelContext`, see [MCP-B Extension API](/reference/runtime/mcp-b-extension-api). For the standard-owned browser surface, see [WebMCP standard API](/reference/webmcp/standard-api).
...
- [`@mcp-b/webmcp-polyfill`](/reference/runtime/webmcp-polyfill) -- Strict core polyfill (used internally)
- [`@mcp-b/webmcp-ts-sdk`](/reference/runtime/webmcp-ts-sdk) -- BrowserMcpServer (used internally)
- [`@mcp-b/transports`](/reference/runtime/transports) -- Tab and iframe transports (used internally)
- [`@mcp-b/webmcp-types`](/reference/runtime/webmcp-types) -- Type definitions
