...
keywords: ["registerTool", "unregisterTool", "@mcp-b/global", "navigator.modelContext", "tool registration", "inputSchema", "annotations"]
icon: "puzzle-piece"
---
...
Available annotation fields: `title`, `readOnlyHint`, `destructiveHint`, `idempotentHint`, `openWorldHint`. See the [`@mcp-b/webmcp-types` reference](/reference/runtime/webmcp-types) for the full `ToolAnnotations` interface.
