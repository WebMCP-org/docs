...
- [mcp-iframe Reference](/reference/runtime/mcp-iframe) for the full API surface
- [Transports Reference](/reference/runtime/transports) for the underlying `IframeParentTransport` and `IframeChildTransport`
