...
keywords: ["mcp-iframe", "iframe", "cross-origin", "namespacing", "@mcp-b/mcp-iframe", "postMessage", "custom element"]
icon: "object-group"
---
...
- [mcp-iframe Reference](/packages/mcp-iframe/overview) for the full API surface
- [Transports Reference](/packages/transports/overview) for the underlying `IframeParentTransport` and `IframeChildTransport`
