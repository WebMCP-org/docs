...
Ask your agent to list sources or tools to confirm the connection is working.
...
- [Local Relay Reference](/reference/tools/webmcp-local-relay) for the full CLI options and architecture details
