...
keywords: ["@mcp-b/webmcp-local-relay", "local relay", "desktop agent", "claude desktop", "cursor", "websocket", "stdio", "embed.js"]
...
<Note>
For Claude Desktop, you can also download the `.mcpb` bundle from [GitHub Releases](https://github.com/WebMCP-org/npm-packages/releases) and double-click to install. No terminal required.
</Note>
...
If your page already registers tools on `navigator.modelContext`, they are picked up automatically.
...
<Frame caption="webmcp.sh: a live demo app with WebMCP tools you can relay to any desktop agent">
  <img src="/images/webmcp-sh-homepage.png" alt="webmcp.sh landing page showing registered WebMCP tools" />
</Frame>
...
- [Local Relay Reference](/packages/webmcp-local-relay/overview) for the full CLI options and architecture details
