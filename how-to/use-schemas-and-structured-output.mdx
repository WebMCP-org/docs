...
keywords: ["inputSchema", "outputSchema", "json schema", "zod", "standard schema", "structured output", "type inference", "validation"]
icon: "brackets-curly"
---
...
- [`@mcp-b/webmcp-types` reference](/packages/webmcp-types/overview) for the full list of schema types and inference utilities.
...
- [Tool Design](/explanation/design/tool-design) for guidance on writing effective tool descriptions and schemas.
