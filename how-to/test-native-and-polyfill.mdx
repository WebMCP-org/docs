...
keywords: ["testing", "playwright", "native api", "polyfill", "e2e", "chrome flags", "modelContextTesting", "runtime contract"]
icon: "flask-vial"
---
...
<Steps>
  <Step title="Enable the WebMCP testing flag">
...
- [Browser Support and Flags](/explanation/webmcp/browser-support-and-flags) for the full Chromium flag reference
- [Native vs. Polyfill vs. Global](/explanation/native-vs-polyfill-vs-global) for why these runtimes differ
