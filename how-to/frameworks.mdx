...
<Tabs>
  <Tab title="React">
    ...
    | Package | Use when |
    |---------|----------|
    | [**@mcp-b/react-webmcp**](/reference/runtime/react) | You want the full MCP-B surface: Zod schemas, prompts, resources, sampling, elicitation |
    | [**usewebmcp**](/reference/runtime/react) | You want strict-core `navigator.modelContext` tools only |
