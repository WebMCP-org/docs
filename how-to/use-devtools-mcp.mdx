...
keywords: ["@mcp-b/chrome-devtools-mcp", "chrome devtools protocol", "browser automation", "list_webmcp_tools", "ai development workflow", "remote debugging"]
icon: "bug"
---
...
<Frame caption="webmcp.sh registers tools for navigation, data management, SQL queries, and more">
  <img src="/images/webmcp-sh-homepage.png" alt="webmcp.sh landing page showing registered WebMCP tools organized by category" />
</Frame>
...
<Frame caption="The agent called the sql_query tool to query the in-browser PostgreSQL database">
  <img src="/images/webmcp-sh-sql-repl-with-results.png" alt="SQL REPL showing query results returned by the agent via the sql_query WebMCP tool" />
</Frame>
...
For the full list of options, see the [chrome-devtools-mcp Reference](/packages/chrome-devtools-mcp/overview).
...
- [chrome-devtools-mcp Reference](/packages/chrome-devtools-mcp/overview) for the full tool list and all CLI options
