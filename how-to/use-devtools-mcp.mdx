...
Your agent should open Chrome, navigate to the page, and record a performance trace.
...
The most powerful use case is building WebMCP tools with your AI agent in a tight feedback loop:
...
For the full list of options, see the [chrome-devtools-mcp Reference](/reference/tools/chrome-devtools-mcp).
...
- [chrome-devtools-mcp Reference](/reference/tools/chrome-devtools-mcp) for the full tool list and all CLI options
