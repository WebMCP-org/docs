...
description: Get started with the MCP-B browser extension for Chrome
icon: puzzle-piece
---
...
<CardGroup cols={2}>
  ...
  >
    Connect to local MCP servers on your machine
  </Card>
  <Card
  ...
  >
    Deep dive into how the extension works
  </Card>
</CardGroup>
...
## Advanced Topics & Developer Resources
...
<AccordionGroup>
  ...
  <Accordion title="Native Host Setup" icon="server">
    Connect your browser's WebMCP tools to local MCP clients like Claude Code and Claude Desktop.

    <Card title="Setup Native Host" icon="arrow-right" href="/native-host-setup">
