...
import { CalculatorTool } from '/snippets-jsx/webmcp-tool-calculator.jsx';
import { ColorConverterTool } from '/snippets-jsx/webmcp-tool-color-converter.jsx';
import { StorageTool } from '/snippets-jsx/webmcp-tool-storage.jsx';
import { DOMQueryTool } from '/snippets-jsx/webmcp-tool-dom-query.jsx';
...
<CardGroup cols={3}>
  <Card title="Build Your First Tool" icon="code" href="/tutorials/first-tool">
    Step-by-step tool tutorial
  </Card>
...
export const ColorConverterTool = () => {
  useEffect(() => {
    ...
    window.navigator.modelContext.registerTool({
      ...
      handler: ({ color, outputFormat = 'all' }) => {
