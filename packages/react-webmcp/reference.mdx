...
It expects `navigator.modelContext` to come from native browser support or from a BrowserMcpServer-based runtime such as [`@mcp-b/global`](/packages/global/overview).
