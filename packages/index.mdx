...
<CardGroup cols={2}>
  ...
  <Card title="@mcp-b/chrome-devtools-mcp" icon="boxes-stacked" href="/packages/chrome-devtools-mcp/overview">
  ...
  <Card title="agent-skills-ts-sdk" icon="boxes-stacked" href="/packages/agent-skills/overview">
