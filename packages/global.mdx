---
title: "@mcp-b/global"
description: "W3C Web Model Context API polyfill implementing navigator.modelContext. Turn JavaScript functions into AI-accessible tools with registerTool() for browser-based agent integration."
...
```html
<script
  src="https://unpkg.com/@mcp-b/global@1.1.2/dist/index.iife.js"
