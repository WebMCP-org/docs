...
description: "Browser-specific transport implementations for Model Context Protocol including TabServerTransport, IframeTransport, and ExtensionServerTransport for web and extension MCP communication."
...
```typescript "server.ts - Tab server setup" twoslash lines icon="server" expandable highlight={36-39}
...
```typescript "client.ts - Tab client setup" twoslash lines icon="plug" highlight={5-7,10-13,20-23}
...
```typescript "iframe-server.ts - Iframe child setup" twoslash lines icon="window" expandable highlight={52-56}
...
```typescript "parent-client.ts - Iframe parent setup" twoslash lines icon="window-maximize" expandable highlight={9-13,26-31}
...
```typescript "background.ts - Extension hub" twoslash lines icon="layer-group" expandable highlight={16-23,26-31}
...
```typescript "content-script.ts - Bridge to background" twoslash lines icon="bridge" expandable highlight={5-7,14-17,20-23,30-42}
import { TabClientTransport } from "@mcp-b/transports";
import { Client } from "@modelcontextprotocol/sdk/client/index.js";
...
```typescript "sidepanel.ts - Extension UI" twoslash lines icon="sidebar" highlight={5-7,15-17,20-24}
...
<CardGroup cols={2}>
  ...
  <Card title="@mcp-b/extension-tools" icon="puzzle-piece" href="/packages/extension-tools">
...
**See also:**
- [Advanced Patterns](/advanced) - Extension and multi-tab scenarios
- [Security Guide](/security) - Origin validation and transport security
- [Troubleshooting](/troubleshooting) - Common transport issues

## External Resources

- [@modelcontextprotocol/sdk](https://www.npmjs.com/package/@modelcontextprotocol/sdk) - Official MCP SDK
- [MCP Protocol Specification](https://modelcontextprotocol.io) - Protocol details
- [Chrome Extension Development](https://developer.chrome.com/docs/extensions) - Extension APIs
