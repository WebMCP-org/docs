...
description: "70+ Chrome Extension API tool classes for MCP. Expose tabs, bookmarks, history, storage, scripting, and more to AI agents."
...
- [@mcp-b/chrome-devtools-mcp](/packages/chrome-devtools-mcp/reference) (DevTools Protocol bridge)
