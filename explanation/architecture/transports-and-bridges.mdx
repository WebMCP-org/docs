...
The parent uses an `IframeParentTransport`. The child uses an `IframeChildTransport`. The [`@mcp-b/mcp-iframe`](/reference/runtime/mcp-iframe) package wraps that setup in a custom element and namespaces the forwarded tools to prevent collisions.
...
For API details, see [@mcp-b/transports](/reference/runtime/transports), [@mcp-b/mcp-iframe](/reference/runtime/mcp-iframe), [@mcp-b/webmcp-local-relay](/reference/tools/webmcp-local-relay), and [@mcp-b/chrome-devtools-mcp](/reference/tools/chrome-devtools-mcp).
