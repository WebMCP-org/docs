...
For shim configuration, see [@mcp-b/webmcp-polyfill](/packages/webmcp-polyfill/overview). For end-to-end testing patterns, see [Test native and polyfill](/how-to/test-native-and-polyfill).
...
| If you need... | Page |
| --- | --- |
| Strict core runtime behavior in all browsers | [@mcp-b/webmcp-polyfill](/packages/webmcp-polyfill/overview) |
| Full runtime with prompts, resources, and transport | [@mcp-b/global](/packages/global/overview) |
| MCP-B extension methods (`callTool`, `registerPrompt`, `registerResource`, `createMessage`, `elicitInput`) | [`@mcp-b/webmcp-ts-sdk` reference](/packages/webmcp-ts-sdk/overview) |
| TypeScript contracts for the standard surface | [@mcp-b/webmcp-types](/packages/webmcp-types/overview) |
