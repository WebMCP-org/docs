...
description: 'Understand how tools are registered, discovered, and managed throughout their lifecycle in WebMCP applications.'
icon: 'screwdriver-wrench'
---

<Info>
**This is an Explanation page** with code examples. It explains *why* tool registration works the way it does. For a hands-on tutorial, see [Your First Tool](/concepts/your-first-tool). For API details, see [@mcp-b/global](/packages/global).
</Info>

## The Registration Model

WebMCP uses a **dynamic registration model** where tools can be added and removed at any time. This differs from static APIs where endpoints are fixed at deployment.

Why dynamic? Because web applications are dynamic:
- Components mount and unmount
- Users navigate between pages
- Features are enabled by roles or flags
- State changes what actions are possible

The registration API reflects this reality.

## Two Registration Methods

### `registerTool()` - The Default Choice
...
<CardGroup cols={2}>
  <Card title="Your First Tool" icon="graduation-cap" href="/concepts/your-first-tool">
    **Tutorial**: Build a working tool step-by-step
  </Card>

  <Card title="Tool Schemas" icon="file-contract" href="/concepts/schemas">
    **Reference**: Input validation and schema definition
  </Card>

  <Card title="Context Engineering" icon="filter" href="/concepts/context-engineering">
    **Explanation**: Why dynamic tool scoping matters
  </Card>

  <Card title="@mcp-b/global" icon="npm" href="/packages/global">
