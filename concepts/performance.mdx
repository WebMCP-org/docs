...
<Info>
**This is a How-to Guide** - it provides actionable patterns for optimizing WebMCP performance. For conceptual understanding of tool lifecycle, see [Tool Registration](/concepts/tool-registration).
</Info>
