...
<Info>
**This is a How-to Guide** with reference examples. It shows you how to register and use prompts. For interactive demos, see [Live Prompt Examples](/live-prompt-examples).
</Info>
