...
<Info>
**This is an Explanation page** - it helps you understand how WebMCP components work together. For hands-on implementation, see [Your First Tool](/concepts/your-first-tool) or the [Quick Start](/quickstart).
</Info>
